...
class BreweryLister:
    ...
    def add_home_brewery(self, brewery_name: str, user_id: str) -> bool:
        ...
        models.cloudredis.REDIS_SERVER.set(
            models.cloudredis.home_key(user_id), brewery_id
        )
        return True
    ...
    def add_brewery_page(
        self, brewery_page: models.breweries.beerlist.BreweryPage
    ) -> None:
    ...
    def find_brewery(
        self, brewery_name
    ) -> tuple[models.breweries.beerlist.BreweryPage | None, str]:
